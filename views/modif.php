...
<form action="" method="POST">
  ...
  <div class=" d-none text-danger regex-ajout" style="font-size:20px;">mauvais format de nom veuillez le changer, evitez de mettre des espaces les majuscules et les underscores</div>
         <label for="name" class="d-none">Titre</label>
         <input type="text" class="form-control regex-nom d-none" id="name" name="name" value="<?=$contents->name?>" required>
   </div>
   <div class="form-group">
         <label for="name">contenu de l'article</label>
         <textarea  class="form-control autogrow" name="content" required><?=$contents->content?></textarea>
   </div>
   <div class="form-group">
